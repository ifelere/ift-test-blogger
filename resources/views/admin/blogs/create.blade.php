            ...
            <div class="md:mx-auto md:w-80">
                <form method="POST" action="{{ route('admin.blogs.store') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <x-text-input name="title" class="block w-full" :value="old('title')" @class([
                    ...
                    <div class="mb-4">
                        <x-textarea name="description"  class="block w-full" placeholder="Content of Blog" :value="old('description')" @class([
